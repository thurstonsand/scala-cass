...
import org.scalatest.{ FlatSpec, Matchers, BeforeAndAfter, BeforeAndAfterAll, OptionValues, EitherValues }

abstract class CassandraTester extends FlatSpec with Matchers with BeforeAndAfter with BeforeAndAfterAll with OptionValues with EitherValues {
