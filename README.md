...
```scala
libraryDependencies += "com.github.thurstonsand" %% "scalacass" % "0.6.15"
```

##### Cassandra 2.1 with Java 7

```scala
libraryDependencies += "com.github.thurstonsand" %% "scalacass" % "0.5.15"
```
...
```xml
<properties>
    <scalaCass.version>0.5.15</scalaCassVersion>
</properties>
```
...
```xml
<properties>
    <scalaCass.version>0.6.15</scalaCassVersion>
</properties>
```
